...
const MSG = {
  BAD_STATUS_CODE: 'Failed, bad status code from download link: ',
  UNKNOWN_SIZE: 'Failed, unknown file size, use a better host',
  FILE_TOO_LARGE: `Failed, file is too big (max ${MAX_FILE_SIZE / 1024 / 1024}mb)`,
};
